...
def sandbox_attach(name_or_id: str, session_label: str | None = None) -> str:
    ...
    # recovered from the journal (#554).  Recorded before the git orientation
    # below, which shells into the container and may fail.
    attach_params: dict[str, Any] = {"name_or_id": name_or_id, "match_type": match_type}
    if session_label is not None and session_label != previous_label:
